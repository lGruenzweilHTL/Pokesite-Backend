public static class TypeUtils {
    ...
    public static string EffectivenessMessage(this Move move, Pokemon defender) {
        return move.EffectivenessAgainst(defender) switch {
            0 => $"It doesn't affect {defender.Name}",
            0.25 or 0.5 => "It's not very effective...",
    ...
    private static double PartialMoveEffectiveness(PokemonTypeFlags moveType, PokemonTypeFlags defenderType) {
        return TypeWeaknesses[defenderType].GetValueOrDefault(moveType, 1d);
    }
}